...
function CheckAuthentication()
{
    ...
    return ($_SESSION['Auth']['Usuario']) ? true : false;
}
...
//$baseUrl = "/{$url[1]}/{$url[2]}/webroot/midia/";
$baseUrl = "/pmvv/app/webroot/midia/";
...
ATTENTION: The trailing slash is required.
*/
$baseDir = realpath(dirname(__FILE__)).resolveUrl($baseUrl);
/*
 * ### Advanced Settings
 */
